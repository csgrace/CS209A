...
└── main/
    └── java/
        └── org.example.demo/
            ...
            └── LoginWindow.java
```
### **1.1 Game Module (`game/Game.java`)**
...
### **1.2 Server Module (`server/Server.java`)**
...
### **1.3 Application Entry Point (`Application.java`)**
...
### **1.4 Concurrency Test (`ConcurrencyTest.java`)**
...
### **1.5 Controller Module (`Controller.java`)**
...
### **1.6 Login Window (`LoginWindow.java`)**
...
### **1.7 System Architectural Features**
...
### 4.2 Handling Unsent Actions During Crashes :
...
#### 4.4.1 Data Consistency Guarantees 数据一致性保证 :
...
#### 4.4.2 Thread Synchronization Choices 线程同步选择 :
...
#### 4.4.3 System Extension Opportunities 系统扩展机会 :
